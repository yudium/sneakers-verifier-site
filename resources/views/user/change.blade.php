    ...
    <div class="lc-place">
        <form
            ...
            <div class="lc-block">
                ...
                <div>
                    <div class="padding-bottom-5px">
                        <div id="image-preview" class="image image-200px image-radius" style="background-image: url({{ asset($user->photo_path) }})"></div>
            ...
            <div class="lc-block">
                ...
                <div>
                    <input type="text" name="name" class="txt txt-primary-color" value="{{ $user->name }}" required>
                </div>
            </div>
            <div class="lc-block">
                <div for="email" class="ctn-main-font ctn-min-color ctn-14px ctn-thin">{{ __('Email') }}</div>
                <div>
                    <input type="email" name="email" class="txt txt-primary-color" value="{{ $user->email }}" required="true">
                </div>
            </div>
