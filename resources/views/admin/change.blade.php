...
@section('content')
    <form
        ...
        <div id="image-preview">
            <img src="{{ asset($admin->photo_path) }}" alt="Photo Profile">
        </div>
        <input id="photo-profile-field" type="file" name="photo"> <br>

        Name:                <input type="text" name="name" placeholder="{{ $admin->name }}"> <br>
        Email:               <input type="text" name="email" placeholder="{{ $admin->email }}"> <br>
